...
- PricePredictionCleanedUp.csv please optimize for google automl
- use 1 and 0 instead of true and false for one hot encoding 
- always update md file with the changes made
Steps performed:
- Loaded `Price_Prediction.csv` with pandas.
...
- Saved the engineered dataset to `PricePredictionCleanedUp.csv`.
