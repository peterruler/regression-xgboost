with XCboost do a regression ot the PricePredictionCleanedUp.csv
create a jupiter notebook if possible to perform all the action and a Cars.py file.
use uv package manager to install xcboost in a newly created conda environment.
